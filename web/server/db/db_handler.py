...
class DB_Handler:
    ...
    def create_table(self, table_schema : server_types.Schema) -> str | None:
        try: 
            columns: List[str] = [f"{k} {v}" for k, v in table_schema.columns]

            colmun_str : str = ", ".join(columns) 
    ...
    def insert_table(self, table_name : str, column_values : Tuple[str,str]) -> str | None:
